...
final class RemoteActionContextProvider extends ActionContextProvider {
  ...
  public Iterable<? extends ActionContext> getActionContexts() {
    ...
    if (remoteOptions.experimentalRemoteSpawnCache) {
      ...
      SpawnRunner spawnWrkRunner = new RemoteSpawnRunner(
          env.getExecRoot(),
          remoteOptions,
  ...
  private static SpawnRunner createFallbackRunner(CommandEnvironment env) {
    ...
    try {
      return SandboxActionContextProvider.withFallback(env, LinuxSandboxedStrategy.create(env, sandboxBase, timeoutGraceSeconds));
    } catch (IOException e) {}
